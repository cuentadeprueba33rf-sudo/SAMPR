...
export const SAM_LOGO = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="50" cy="50" r="48" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.2"/>
    <path d="M50 20C33.4315 20 20 33.4315 20 50C20 66.5685 33.4315 80 50 80C66.5685 80 80 66.5685 80 50" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M40 50L50 60L60 40" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
export const ICONS = {
  Menu: () => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="4" y1="9" x2="20" y2="9"></line><line x1="4" y1="15" x2="20" y2="15"></line></svg>
  ),
  Edit: () => (
  ...
  ThumbDown: () => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h3a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-3"></path></svg>
  ),
  Speaker: () => (
  ...
  Waveform: () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="10" width="2" height="4" rx="1"></rect><rect x="7" y="7" width="2" height="10" rx="1"></rect><rect x="11" y="4" width="2" height="16" rx="1"></rect><rect x="15" y="8" width="2" height="8" rx="1"></rect><rect x="19" y="11" width="2" height="2" rx="1"></rect></svg>
  ),
  Send: () => (
